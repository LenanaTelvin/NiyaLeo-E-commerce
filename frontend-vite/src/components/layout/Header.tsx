  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4 h-16">
          ...
          <div className="flex items-center gap-1 ml-auto">
            ...
            <Link
              to="/cart"
              className="relative p-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50
              ...
              <div className="flex items-center gap-2 ml-1">
                <Link
                  ...
                  className="text-sm text-gray-600 hover:text-gray-900 px-3 py-2
                    rounded-lg hover:bg-gray-50 transition-colors hidden sm:block"
                >
                  Sign in
                </Link>
                <Link
      ...
      <div className="border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center h-10 gap-1 overflow-x-auto">
            <Link
              to="/products"
              className="text-xs text-gray-500 hover:text-gray-900 px-3 py-1.5
                rounded-md hover:bg-gray-50 whitespace-nowrap transition-colors font-medium"
            >
              All
            </Link>
            {categories?.map(cat => (
              <Link
                ...
                className="text-xs text-gray-500 hover:text-gray-900 px-3 py-1.5
                  rounded-md hover:bg-gray-50 whitespace-nowrap transition-colors"
              >
                {cat.name}
              </Link>
            ))}
